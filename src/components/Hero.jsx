...
const Hero = ({ scrollContainer }) => {
  return (
    <section className="parallax">
      ...
      <img className="parallax__stars" src="src/assets/parallax/1Stars.svg" alt="" />
      <img className="parallax__planets" src="src/assets/parallax/2Planets.svg" alt="" />
      <img className="parallax__mountain1" src="src/assets/parallax/3Mountain.svg" alt="" />
      <img className="parallax__mountain2" src="src/assets/parallax/4Mountain.svg" alt="" />
      <img className="parallax__crater" src="src/assets/parallax/5Crater.svg" alt="" />
      <img className="parallax__sun" src="src/assets/parallax/6Sun.svg" alt="" />
